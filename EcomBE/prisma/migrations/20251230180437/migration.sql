...
CREATE TABLE [dbo].[user_addresses] (
    ...
    [is_default] BIT NOT NULL CONSTRAINT [user_addresses_is_default_df] DEFAULT 0,
    [created_at] DATETIME2 NOT NULL CONSTRAINT [user_addresses_created_at_df] DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE [dbo].[shops] (
    ...
    [rating] FLOAT(53) CONSTRAINT [shops_rating_df] DEFAULT 0,
    ...
    [status] NVARCHAR(1000) NOT NULL CONSTRAINT [shops_status_df] DEFAULT 'ACTIVE',
...
CREATE TABLE [dbo].[products] (
    ...
    [status] NVARCHAR(1000) NOT NULL CONSTRAINT [products_status_df] DEFAULT 'PENDING_APPROVAL',
...
-- AddForeignKey
ALTER TABLE [dbo].[shops] ADD CONSTRAINT [shops_seller_id_fkey] FOREIGN KEY ([seller_id]) REFERENCES [dbo].[users]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE [dbo].[products] ADD CONSTRAINT [products_shop_id_fkey] FOREIGN KEY ([shop_id]) REFERENCES [dbo].[shops]([id]) ON DELETE NO ACTION ON UPDATE CASCADE;
